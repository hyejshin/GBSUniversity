...
<div class="container">
    ...
    <div id="chatDiv" style="display:none;">
        ...
        <div id="userNm" >        ${user.user_id}</div>
        <textarea  style="overflow-y: scroll; resize:none;" readonly ></textarea>
    ...
    <input type="button" class="btn btn-primary" id="showList" value="Class List" /> 
    <input type="button" class="btn btn-warining" id="showChat" value="Chat" />
