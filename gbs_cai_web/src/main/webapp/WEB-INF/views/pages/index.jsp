					...
					<div class="blog">
						<div class="top-blog">
							<div class="col-md-6 blog-top">
								<a href="single.jsp"><img class="img-responsive" src="/webapp/resources/images/b1.jpg" alt=" "></a>
							...
							<div class="col-md-6 blog-top">
								<a href="single.jsp"><img class="img-responsive" src="/webapp/resources/images/b2.jpg" alt=" "></a>
								<p>Praesent interdum blandit quam. Asunt in anim uis aute
									irure dolor in reprehenderit in voluptate velit esse cillum
									dolore. Praesent interdum blandit quam. Asunt in anim uis aute
									irure dolor in reprehenderit in voluptate velit esse cillum
						...
						<div class="top-blog">
							...
							<div class="col-md-6 blog-top">
								<a href="single.jsp"><img class="img-responsive"	src="/webapp/resources/images/b3.jpg" alt=" "></a>
								<p>Praesent interdum blandit quam. Asunt in anim uis aute
									irure dolor in reprehenderit in voluptate velit esse cillum
									dolore. Praesent interdum blandit quam. Asunt in anim uis aute
									irure dolor in reprehenderit in voluptate velit esse cillum
