...
<div class="container">		
			 ...
			 <div class="details">		 
				 <div align="center" class="col-md-7 embed-responsive" style="width:100%; height:300px;">
					<video class="embed-responsive-item" controls> <source src="<c:url value="/images/Welcoming Message_KH Song v2.mp4" />"/> </video>
				</div>
				 <div class="clearfix"></div>
			 </div> 
