...
# user table에 import 
load data local infile 'C://ProgramData//MySQL//MySQL Server 5.7//Uploads//user.csv' into table ibm.user fields terminated by ',' ENCLOSED BY '"' LINES TERMINATED BY '\r' (user_id,user_nm,password,type);
